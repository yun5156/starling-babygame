package 
{
    ...
    public class MyProgressBar extends Sprite
    {
        private var mBar:Quad;
        private var mBackground:Image;
        
        public function MyProgressBar(width:int, height:int)
        {
            init(width, height);
        }
        ...
        private function init(width:int, height:int):void
        {
            ...
            bgShape.graphics.beginFill(0x76d0ee, 0.9);
            ...
            mBar = new Quad(width - 2*padding, height - 2*padding, 0xd0fbff);
